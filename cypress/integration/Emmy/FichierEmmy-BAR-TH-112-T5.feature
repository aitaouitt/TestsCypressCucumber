Feature: Checker le Contenu du Fichier Emmy
  ...
  Cette Feature permet de:
    - Creer une OS BAR TH 112 Sans Coup de Pouce, la passer en DEPOSABLE, creer un Depot avec et checker le contenu du fichier Emmy
...
@focus@Emmy   
  Scenario: Cloturer l OS crée précédemment
    ...
    And Cloturer l OS
@focus@Emmy
  Scenario Outline: Création de l OS BAR-TH-112 PRECAIRE_ENERGETIQUE Sans Coup de Pouce
    ...
    Examples:
      ...
      | chauffer | maison   | electricite     | individuel        | Radiateurs_electriques112 | 110     | STANDARD | 30 avenue de bretagne | 78000 | Versailles |
...
@focus@Emmy
  Scenario Outline: Selection du Depôt et Verification du Fichier Emmy
    ...
    And Recuperation des infos chantier "bar_th_112"
    Then Selection du Depot et telechargement du fichier Emmy
    Then Lecture du fichier Emmy "BAR-TH-112","T5","<adresseTravaux>","<CP>","<ville>","<revenus>","<CDP>","<logement>","<surface>","<chauffageLogement>"
        Examples:
      | souhait  | logement | chauffageActuel | chauffageLogement | typeTravaux               | surface | revenus  | adresseTravaux        | CP    | ville      | CDP |
      | chauffer | maison   | electricite     | individuel        | Radiateurs_electriques112 | 110     | STANDARD | 30 avenue de bretagne | 78000 | Versailles | NON |
