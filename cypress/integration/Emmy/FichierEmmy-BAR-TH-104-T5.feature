Feature: Checker le Contenu du Fichier Emmy
  ...
  Cette Feature permet de:
    1- Creer une OS BAR TH 104 Avec Coup de Pouce, la passer en DEPOSABLE, creer un Depot avec et checker le contenu du fichier Emmy
    2- Creer une OS BAR TH 104 Sans Coup de Pouce, la passer en DEPOSABLE, creer un Depot avec et checker le contenu du fichier Emmy
...
#       | chauffer | maison      | gaz             | individuel        | pompeAchaleurAirEau    | 95      | PRECAIRE_ENERGETIQUE | 26 avenue de bretagne | 13000 | Marseille  |
# @focus@Emmy
...
#     When Valider le dossier en Qualite OK et passer en "DEPOSABLE"
#     And Creer un depot avec le dossier et passer en DEPOSE
# @focus@Emmy
#   Scenario Outline: Selection du Depôt et Verification du Fichier Emmy
#     Given Je me suis connecte au BO
#     When Selection du Depot et telechargement du fichier Emmy
#     Then Lecture du fichier Emmy "BAR-TH-104","<adresseTravaux>","<CP>","<ville>","<revenus>","<CDP>","<logement>","<surface>","<chauffageLogement>"
#         Examples:
#       | souhait  | logement    | chauffageActuel | chauffageLogement | typeTravaux            | surface | revenus              | adresseTravaux        | CP    | ville      | CDP |
#       | chauffer | maison      | gaz             | individuel        | pompeAchaleurAirEau    | 95      | PRECAIRE_ENERGETIQUE | 26 avenue de bretagne | 13000 | Marseille  | OUI |
...
@focus@Emmy   
  Scenario: Cloturer l OS crée précédemment
    ...
    And Cloturer l OS
@focus@Emmy
  Scenario Outline: Création de l OS BAR-TH-104 PRECAIRE_ENERGETIQUE Sans Coup de Pouce
    Given Je cree mon OS sur Monexpert "<souhait>","<logement>","<chauffageActuel>","<chauffageLogement>","<typeTravaux>","<surface>","<revenus>","<adresseTravaux>","<CP>","<ville>"
    When Je me connecte à monExpert
    And Je recupere la reference du dernier OS cree dans monExpert
    Examples:
      | souhait  | logement    | chauffageActuel | chauffageLogement | typeTravaux         | surface | revenus | adresseTravaux     | CP    | ville       |
      | chauffer | appartement | pompeAChaleur   | individuel        | pompeAchaleurAirEau | 65      | MODESTE | 28 avenue de Paris | 17000 | La rochelle |
@focus@Emmy
  Scenario: Chargement devis non signé et les impots dans monExpert
    Given Je me connecte à monExpert
    And Chargement du justificatif des impots dans monExpert
...
@focus@Emmy
  Scenario Outline: Selection du Depôt et Verification du Fichier Emmy
    ...
    And Recuperation des infos chantier "bar_th_104"
    Then Selection du Depot et telechargement du fichier Emmy
    Then Lecture du fichier Emmy "BAR-TH-104","T5","<adresseTravaux>","<CP>","<ville>","<revenus>","<CDP>","<logement>","<surface>","<chauffageLogement>"
        Examples:
      | souhait  | logement    | chauffageActuel | chauffageLogement | typeTravaux         | surface | revenus | adresseTravaux     | CP    | ville       | CDP |
      | chauffer | appartement | pompeAChaleur   | individuel        | pompeAchaleurAirEau | 65      | MODESTE | 28 avenue de Paris | 17000 | La rochelle | NON |
