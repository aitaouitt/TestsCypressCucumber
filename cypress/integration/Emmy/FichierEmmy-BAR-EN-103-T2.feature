Feature: Checker le Contenu du Fichier Emmy
  ...
  Cette Feature permet de:
    - Creer une OS BAR EN 103 Sans Coup de Pouce, la passer en DEPOSABLE, creer un Depot avec et checker le contenu du fichier Emmy
...
#     And Cloturer l OS
@focus@Emmy
  Scenario Outline: Creation de l OS BAR-EN-103 dans ProCee
    ...
    Examples:
      ...
      | Isolation  | appartement | electricite     | individuel        | Sols        | 110     | PRECAIRE_ENERGETIQUE | 34 avenue de bretagne | 78000 | Versailles | Intérieur | Non         |
@focus@Emmy
...
@focus@Emmy
  Scenario Outline: Selection du Depôt et Verification du Fichier Emmy
    ...
    And Recuperation des infos chantier "bar_en_103"
    Then Selection du Depot et telechargement du fichier Emmy
    And Lecture du fichier Emmy "BAR-EN-103","T2","<adresseTravaux>","<CP>","<ville>","<revenus>","<CDP>","<logement>","<surface>","<chauffageLogement>"
        Examples:
      | souhait   | logement    | chauffageActuel | chauffageLogement | typeTravaux | surface | revenus              | adresseTravaux        | CP    | ville      | CDP |
      | Isolation | appartement | electricite     | individuel        | Sols        | 110     | PRECAIRE_ENERGETIQUE | 34 avenue de bretagne | 78000 | Versailles | NON |