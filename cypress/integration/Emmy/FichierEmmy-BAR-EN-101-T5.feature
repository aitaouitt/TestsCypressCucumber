...
@focus@Emmy   
  Scenario: Cloturer l OS crée précédemment
    ...
    And Cloturer l OS
@focus@Emmy
  Scenario Outline: Création de l OS BAR-TH-101 PRECAIRE_ENERGETIQUE Sans Coup de Pouce
    ...
    Examples:
      ...
      | Isoler  | appartement | electricite     | individuel        | comblesPerdusOuAmenageables | 110     | PRECAIRE_ENERGETIQUE | 32 avenue de bretagne | 78000 | Versailles |
...
@focus@Emmy
  Scenario Outline: Selection du Depôt et Verification du Fichier Emmy
    ...
    And Lecture du fichier Emmy "BAR-EN-101","T5","<adresseTravaux>","<CP>","<ville>","<revenus>","<CDP>","<logement>","<surface>","<chauffageLogement>"
        Examples:
      | souhait | logement    | chauffageActuel | chauffageLogement | typeTravaux                 | surface | revenus              | adresseTravaux        | CP    | ville      | CDP |
      | Isoler  | appartement | electricite     | individuel        | comblesPerdusOuAmenageables | 110     | PRECAIRE_ENERGETIQUE | 32 avenue de bretagne | 78000 | Versailles | NON |