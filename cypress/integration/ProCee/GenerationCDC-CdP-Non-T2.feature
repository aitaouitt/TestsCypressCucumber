Feature: Generation CDC Sans Coup de Pouce sur BAR TH 104 T2
  ...
  Elle verifie si le titre du projet ne contient pas l image du pouce
  ...
  Scenario: Cloturer l OS crée précédemment
    ...
    And Cloturer l OS
  @ProCee@focus
  Scenario Outline: Creation de l OS BAR TH 104 T2 Grand Precaire sans Coup de Pouce dans ProCee
    ...
    Examples:
      ...
      | Chauffage  | maison   | electricite     | collectif         | Pompe à chaleur | 110     | PRECAIRE_ENERGETIQUE | 19 avenue de bretagne | 78000 | Versailles | Pompe à chaleur air/eau | Non         |
...
#                               | pompeAChaleur
  ...
  Scenario Outline: Checker le contenu du PDF CDC
    ...
    And Ckecker le PDf "CDCT2","<adresseTravaux>","<CP>","<ville>","Non"
    And Redirection info beneficiaire
    And Cloturer l OS
    Examples:
      | adresseTravaux        | CP    | ville      |
      | 19 avenue de bretagne | 78000 | Versailles |